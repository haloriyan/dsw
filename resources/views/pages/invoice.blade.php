...
<head>
    ...
    <title>Invoice &#8211; Data Science Weekend</title>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($invoices as $invoice)
                                        <tr>
                                            <td>{{ $invoice->ticket->name }} ({{ $invoice->ticket->event->title }})</td>
                                            <td>{{ $invoice->qty }}</td>
                                            <td>@currency($invoice->total_pay)</td>
                                            <td>
                                                <a href="{{ route('ticket.checkout', ['orderID' => $invoice->id]) }}" class="btn btn-success">Pay</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
