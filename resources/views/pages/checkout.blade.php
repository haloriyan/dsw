...
<head>
    ...
    <title>Checkout &#8211; Data Science Weekend</title>
            ...
            <section class="price-section-two mt-4" style="background-color:#fff; background-image:url('https://54.179.228.148/wp-content/uploads/2020/10/chairs-2181994_1920.jpg');">
                <div class="auto-container mt-4">
                    ...
                    <div class="sec-title centered mt-4">
                        ...
                        <div class="title mt-3">{{ $data->ticket->event->title }}</div>
                    ...
                    <div class="text-center">
                        <div class="d-inline-block w-50 shadow rounded p-5">
                            <form action="#" method="POST" class="text-left" id="formBuy">
                                {{ csrf_field() }}
                                <button type="button" class="primer lebar-100" id="pay-button">Pay with Midtrans</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script src="{{ $snapJsURL }}" data-client-key="<Set your ClientKey here>"></script>
<script type="text/javascript">
    let orderID = "{{ $data->id }}";
    ...
    document.getElementById('pay-button').onclick = function(){
        ...
        snap.pay('{{ $snapToken }}', {
            ...
            onSuccess: function(result){
                ...
                let req = post("{{ route('ticket.completeOrder') }}", {
                    csrfToken: csrfToken,
                    orderID: orderID
                })
                .then(res => {
