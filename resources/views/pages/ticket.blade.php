...
<head>
    ...
    <title>Tickets &#8211; Dat Science Weekend</title>
...
@media only screen and (min-width: 992px) {#contact .sec-title.centered {text-align: center;margin-left: -350px;}}
    ...
    @include('Components.Header')
			        <!-- Price Section Two -->
	<section class="price-section-two mt-4" style="background-color:#EDEDED; background-image:url('https://54.179.228.148/wp-content/uploads/2020/10/chairs-2181994_1920.jpg');">
