                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control iconPreview" id="iconPreviewAdd" onclick="removeIcon()"><i class="{{ $contact->icon }}"></i> <i class="fas fa-times float-right mt-1 text-danger"></i></div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $contact->value }}" class="form-control" placeholder="URL, Nomor Telepon, atau Email" name="value">
                                            </div>
                                        </div>
