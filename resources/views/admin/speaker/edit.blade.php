                            ...
                            @foreach ($speaker->contacts as $contact)
                                ...
                                <div id="contactArea" class="mt-3">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Icon :</label>
                                            <input type="text" class="form-control icon" name="speaker_contacts_icon[]" oninput="searchIcon(this.value, this)" id="icon" required>
                                        ...
                                        <div class="col-md-4">
                                            <label>Name :</label>
                                            <input type="text" class="form-control" name="speaker_contacts_name[]" required value="{{ $contact->name }}" oninput="updatingContact()">
                                        </div>
                                        <div class="col-md-3">
                                            <label>Value :</label>
                                            <input type="text" class="form-control" name="speaker_contacts_value[]" required value="{{ $contact->value }}" oninput="updatingContact()">
                                        </div>
                                        <div class="col-md-1">
