...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('judge.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <input type="hidden" name="id" value="{{ $judge->id }}" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $judge->name }}" type="text" class="form-control" name="name" required>
                    </div>
                    <div class="form-group">
                        <label for="name">No. Telepon :</label>
                        <input value="{{ $judge->phone }}" type="text" class="form-control" name="phone" required>
                    </div>
                    <div class="form-group">
                        <label for="email">Email :</label>
                        <input value="{{ $judge->email }}" type="email" class="form-control" name="email" required>
                    </div>
                    <div class="form-group">
                        <label for="name">Linkedin Profile :</label>
                        <input value="{{ $judge->linkedin_profile }}" type="text" class="form-control"
                        ...
                        <div id="contactArea" class="mt-3">
                            ...
                            <div id="contactArea" class="mt-3">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label>Icon :</label>
                                        <input type="text" class="form-control icon" name="judges_contacts_icon[]"
                                    ...
                                    <div class="col-md-4">
                                        <label>Name :</label>
                                        <input type="text" class="form-control" name="judges_contacts_name[]" required
                                            value="{{ $contact->name }}" oninput="updatingContact()">
                                    </div>
                                    <div class="col-md-3">
                                        <label>Link :</label>
                                        <input type="text" class="form-control" name="judges_contacts_value[]" required
...
<script>
    ...
    <label>Icon :</label>
    <input type="text" class="form-control" name="judges_contacts_icon[]" oninput="searchIcon(this.value, this)" id="icon">
    ...
    <div class="col-md-4">
    <label>Name :</label>
    <input type="text" class="form-control" name="judges_contacts_name[]">
    </div>
    <div class="col-md-3">
    <label>Link :</label>
    <input type="text" class="form-control" name="judges_contacts_value[]">
    </div>
    <div class="col-md-1">
    <div class="col-md-1">
        <button class="btn btn-danger mt-4" type="button" onclick="removeContact(this)">
